...
def _convert_examples_to_features(
    ...
    #     print('inputs ' , inputs) # dict  ={input_ids, tok_type_id, attention_mask}
    #     if label_list is not None:
    ...
    #     logger.info("*** Example ***")
    #     logger.info("sample text a: %s" , example.text_a)
    #     logger.info("sample text b: %s" , example.text_b)
    # # sample = examples[0]
    #     print(features[0])
    # print('sample text a', sample.text_a)
    # print('sample text b', sample.text_b)
